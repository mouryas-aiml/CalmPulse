...
import { subscribeToUserProgress, subscribeToUserActivities } from '../services/firebaseService';
import { downloadProgressPDF } from '../utils/pdfGenerator';
...
function Profile() {
    ...
    const setupRealTimeListeners = async () => {
      try {
        if (currentUser) {
          ...
          unsubscribeProgress = subscribeToUserProgress(currentUser.uid, (progressData) => {
            setRealTimeProgress({
              insightsRead: progressData.insightsRead || 0,
              toolsUsed: progressData.toolsUsed || 0,
              routinesCompleted: progressData.routinesCompleted || 0,
              mindmitraChats: progressData.mindmitraChats || 0
            });
          });
          
          // Set up real-time listener for activities
          unsubscribeActivities = subscribeToUserActivities(currentUser.uid, 5, (activities) => {
  ...
  // Update the handleDownloadData function
  const handleDownloadData = () => {
    // Show loading indicator
    setIsDownloading(true);
    
    try {
      // Small delay to show loading state (PDF generation is usually fast)
      setTimeout(() => {
        // Call the PDF generator with user data
        downloadProgressPDF(
          user, 
          {
            ...realTimeProgress,
            averageMoodLastWeek: progressData.averageMoodLastWeek,
            moodTrend: progressData.moodTrend,
            moodHistory: progressData.moodHistory
          }, 
          recentActivities
        );
      ...
      setIsDownloading(false);
      setUpdateMessage({ 
        text: `Error generating your progress report: ${error.message}`, 
        isError: true 
      });
    }
  };
    ...
    <div className="profile">
              ...
              <div className="tab-content">
                ...
                <div className="progress-overview">
                  <div className="progress-header">
                    <h3><i className="fas fa-chart-line"></i> <TranslatedText text="Progress Overview" /></h3>
                    <div className="progress-refresh">
                      <span className="last-updated"><TranslatedText text="Real-time data" /></span>
                  ...
                  <div className="stats-cards">
                    ...
                    <div className="stat-card">
                      ...
                      <div className="stat-info">
                        <div className="stat-value">{realTimeProgress.mindmitraChats}</div>
                        <div className="stat-label"><TranslatedText text="Mindmitra Chats" /></div>
                      </div>
                      <div className="stat-trend positive">
                        <i className="fas fa-arrow-up"></i>
                        <span>23%</span>
                ...
                <div className="progress-sections">
                  <div className="progress-section mood-tracker">
                    <div className="section-header">
                      <h3><i className="fas fa-smile"></i> <TranslatedText text="Wellness Trend" /></h3>
                    ...
                    <div className="mood-status">
                      ...
                      <div className="average-mood">
                        ...
                        <span className="mood-label"><TranslatedText text="Average wellness score" /></span>
                      </div>
                    </div>
                  ...
                  <div className="progress-section activity-summary">
                    <div className="section-header">
                      <h3><i className="fas fa-history"></i> <TranslatedText text="Recent Activity" /></h3>
                      <div className="section-actions">
                        ...
                        <li className="no-activity">
                          <div className="empty-state">
                            ...
                            <button className="explore-btn">
                              <TranslatedText text="Explore Features" />
                            </button>
                          </div>
                        </li>
                      )}
                ...
                <div className="progress-section achievements">
                  <div className="section-header">
                    <h3><i className="fas fa-trophy"></i> <TranslatedText text="Achievements" /></h3>
                  </div>
                  ...
                  <div className="achievements-grid">
                    <div className="achievement-card unlocked">
                      ...
                      <div className="achievement-info">
                        <h4><TranslatedText text="Avid Reader" /></h4>
                        <p><TranslatedText text="Read 5 insights" /></p>
                      </div>
                    ...
                    <div className="achievement-card unlocked">
                      ...
                      <div className="achievement-info">
                        <h4><TranslatedText text="Tool Explorer" /></h4>
                        <p><TranslatedText text="Try 3 different coping tools" /></p>
                      </div>
                      <div className="achievement-badge">
                        <i className="fas fa-check-circle"></i>
                      </div>
                    ...
                    <div className="achievement-card">
                      ...
                      <div className="achievement-info">
                        <h4><TranslatedText text="Routine Master" /></h4>
                        <p><TranslatedText text="Complete 5 routines" /></p>
                      </div>
                      <div className="achievement-progress">
                        <div className="progress-bar">
                          <div className="progress-fill" style={{width: `${(realTimeProgress.routinesCompleted / 5) * 100}%`}}></div>
                        </div>
                        <span>{realTimeProgress.routinesCompleted}/5</span>
                      </div>
                    </div>
                    ...
                    <div className="achievement-card">
                      ...
                      <div className="achievement-info">
                        <h4><TranslatedText text="Conversation Starter" /></h4>
                        <p><TranslatedText text="Have 10 chats with Mindmitra" /></p>
                      </div>
                      <div className="achievement-progress">
                        <div className="progress-bar">
                          <div className="progress-fill" style={{width: `${(realTimeProgress.mindmitraChats / 10) * 100}%`}}></div>
                        </div>
                        <span>{realTimeProgress.mindmitraChats}/10</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="progress-section recommendations">
                  <div className="section-header">
                    <h3><i className="fas fa-lightbulb"></i> <TranslatedText text="Personalized Recommendations" /></h3>
                  </div>
                  ...
                  <div className="recommendations-grid">
                    <div className="recommendation-card">
                      ...
                      <div className="recommendation-content">
                        <h4><TranslatedText text="Try Mindfulness Meditation" /></h4>
                        <p><TranslatedText text="Based on your usage patterns, this might help with stress management." /></p>
                        <button className="try-now-btn">
                          <TranslatedText text="Try Now" />
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="recommendation-card">
                      ...
                      <div className="recommendation-content">
                        <h4><TranslatedText text="Read About Sleep Hygiene" /></h4>
                        <p><TranslatedText text="Improve your sleep quality with these evidence-based insights." /></p>
                        <button className="try-now-btn">
                ...
                <div className="privacy-section">
                  ...
                  <div className="privacy-group">
                    ...
                    <div className="data-actions">
                      <button 
                        className={`data-btn ${isDownloading ? 'loading' : ''}`} 
                        onClick={handleDownloadData}
                        disabled={isDownloading}
                      >
                        <i className="fas fa-download"></i> 
                        <TranslatedText text={isDownloading ? "Generating Report..." : "Download My Data"} />
                      </button>
      ...
      {showDownloadSuccess && (
        <div className="download-success">
          <i className="fas fa-check-circle"></i>
          <div>
            <h4><TranslatedText text="Download Complete" /></h4>
            <p><TranslatedText text="Your progress report has been downloaded successfully." /></p>
          </div>
        </div>
      )}
    </div>
